...
def main():
    ...
    for index, feature in enumerate(range(0,30,6)):
        ...
        y = dataset[:num_data_points,-1] # last element in column used as label
        ...
        filler = np.zeros((X.shape[0], 28), dtype='float')
        ...
        print("Loss =", loss)
        print("Binary Accuracy =", categorical_accuracy)
