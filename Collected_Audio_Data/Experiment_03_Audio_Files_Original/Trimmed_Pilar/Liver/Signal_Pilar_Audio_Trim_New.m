...
% Import file
audiofile = 'SampleC_30mm_Liver.wav';
...
figure(5);
[pks, locs] = findpeaks(sth,t,'MinPeakDistance',0.6,'MinPeakProminence',0.02); % Find prominent peaks

findpeaks(sth,t,'MinPeakDistance',0.6,'MinPeakProminence',0.02,'Annotate','extents','WidthReference','halfheight') %Plot peaks
