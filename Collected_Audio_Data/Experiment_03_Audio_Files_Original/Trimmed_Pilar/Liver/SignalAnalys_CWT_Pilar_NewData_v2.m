...
for i = 2:B10S_col
    catB10 = B10_Avg_R(:,i);
	CB10_Avg_R = cat(1, CB10_Avg_R, catA15);
end
...
for i = 2:C10S_col
    catC10 = C10_Avg_R(:,i);
	CC10_Avg_R = cat(1, CC10_Avg_R, catA15);
end
...
title('CWT Scalogram - Average for Samples A, 10mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples A, 15mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples A, 20mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples A, 25mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples A, 30mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples B, 10mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples B, 15mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples B, 20mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples B, 25mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples B, 30mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples C, 10mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples C, 15mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples C, 20mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples C, 25mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
title('CWT Scalogram - Average for Samples C, 30mm','fontsize',14)
xlabel('Time(ms)','fontsize',14);
ylabel('Frequency (Hz)','fontsize',14)
set(gca,'FontSize',14)
...
% Samples A
subplot(1,3,1);
plot(frq_A10,cfs_A10,'LineWidth',0.5,'Color','b')
hold on
plot(frq_A15,cfs_A15,'LineWidth',0.5,'Color','r')
hold on
plot(frq_A20,cfs_A20,'LineWidth',0.5,'Color','g')
hold on
plot(frq_A25,cfs_A25,'LineWidth',0.5,'Color','m')
hold on
plot(frq_A30,cfs_A30,'LineWidth',0.5,'Color','y')
hold off
...
% Samples B
subplot(1,3,2);
plot(frq_B10,cfs_B10,'LineWidth',0.5,'Color','b')
hold on
plot(frq_B15,cfs_B15,'LineWidth',0.5,'Color','r')
hold on
plot(frq_B20,cfs_B20,'LineWidth',0.5,'Color','g')
hold on
plot(frq_B25,cfs_B25,'LineWidth',0.5,'Color','m')
hold on
plot(frq_B30,cfs_B30,'LineWidth',0.5,'Color','y')
hold off
...
% Samples C
subplot(1,3,3);
plot(frq_C10,cfs_C10,'LineWidth',0.5,'Color','b')
hold on
plot(frq_C15,cfs_C15,'LineWidth',0.5,'Color','r')
hold on
plot(frq_C20,cfs_C20,'LineWidth',0.5,'Color','g')
hold on
plot(frq_C25,cfs_C25,'LineWidth',0.5,'Color','m')
hold on
plot(frq_C30,cfs_C30,'LineWidth',0.5,'Color','y')
hold off
...
% Liver thickness = 10mm
subplot(2,3,1);
plot(frq_A10,cfs_A10,'LineWidth',1.5,'Color','b')
hold on
plot(frq_B10,cfs_B10,'LineWidth',1.5,'Color','r')
hold on
plot(frq_C10,cfs_C10,'LineWidth',1.5,'Color','g')
hold off
...
% Liver thickness = 15mm
subplot(2,3,2);
plot(frq_A10,cfs_A15,'LineWidth',1.5,'Color','b')
hold on
plot(frq_B10,cfs_B15,'LineWidth',1.5,'Color','r')
hold on
plot(frq_C10,cfs_C15,'LineWidth',1.5,'Color','g')
hold off
...
% Liver thickness = 20mm
subplot(2,3,3);
plot(frq_A10,cfs_A20,'LineWidth',1.5,'Color','b')
hold on
plot(frq_B10,cfs_B20,'LineWidth',1.5,'Color','r')
hold on
plot(frq_C10,cfs_C20,'LineWidth',1.5,'Color','g')
hold off
...
% Liver thickness = 25mm
subplot(2,3,4);
plot(frq_A10,cfs_A25,'LineWidth',1.5,'Color','b')
hold on
plot(frq_B10,cfs_B25,'LineWidth',1.5,'Color','r')
hold on
plot(frq_C10,cfs_C25,'LineWidth',1.5,'Color','g')
hold off
...
% Liver thickness = 30mm
subplot(2,3,5);
plot(frq_A10,cfs_A30,'LineWidth',1.5,'Color','b')
hold on
plot(frq_B10,cfs_B30,'LineWidth',1.5,'Color','r')
hold on
plot(frq_C10,cfs_C30,'LineWidth',1.5,'Color','g')
hold off
